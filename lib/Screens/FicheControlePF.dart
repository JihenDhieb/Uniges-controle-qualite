...
class ControlePFScreen extends StatefulWidget {
  ...
  ControlePFScreen({Key key, String code}) : super(key: key) {
  ...
  @override
  _ControlePFScreenState createState() => _ControlePFScreenState();
}

class _ControlePFScreenState extends State<ControlePFScreen> {
  ...
  Future<void> fetchAspects() async {
    try {
      var response = await get(Uri.parse(controlePFURL + widget.qF_Num + ",851"));
